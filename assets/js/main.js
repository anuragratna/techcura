        ...
        fetch('/api/articles')
            ...
            .then(json => {
                ...
                articles.forEach(article => {
                    ...
                    card.innerHTML = `
                        <div class="card-link-wrapper" onclick="window.location.href='${article.link}'">
                            ...
                            <span class="text-link" style="margin-top: 1rem;" data-i18n="articles.readMore">Read More</span>
                        </div>
                    `;
